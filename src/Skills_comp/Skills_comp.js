 ...
 class Skills_comp extends React.Component {
  ...
  componentDidMount()
  {
    ...
    this.setState({
      ...
      <SkillsBtn_comp key={4} title={"Dynamo"} details={'a simulation language and accompanying graphical notation developed within the system dynamics analytical framework.'} _onClick={this.BtnClickHandeler} ImgUrl={'media/100x100Dynamo.png'}            MainImgUrl={'media/400x500Dynamo.png'} selected={this.state.selected}     classTheme={"skillBtnCont"}   fullDetails={""} chartParams={["Custom Packages", "Python RevitAPI", "UI from Dynamo"]} chartVals={[70,80,75]}  />,
