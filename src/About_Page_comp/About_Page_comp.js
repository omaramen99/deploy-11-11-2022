    ...
    <div class="content-inner">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-lg-7">
                <p>
                    I'm a Mechanical based BIM Engineer interested in developing and implementing BIM software, 
                    specialized in BIM Automation and BIM application development using desktop development and full 
                    stack web development technologies.<br/>
                ...
                <div class="form">
                    <form action="" class="needs-validation" id='form1sendmessage'> 
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="email" class="form-control" pattern="([a-z\d\.-]+)@([a-z\d-]+)\.([a-z]{2,8})" name="email" id='formsubmitAemail' placeholder="Your Email" required/>
                                <div class="valid-feedback">Valid.</div>
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                        </div>
                        ...
                        <div><button class="btn" type="submit" onClick={(e)=>(this.CustomSubmit(e))} >Send Message</button></div>
                    </form>
                </div>
            </div>
        </div>
